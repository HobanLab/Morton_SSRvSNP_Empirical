...
# R80_NOMAF Capture rates
reportAllelicCapture_Together(QUAC.R80_NOMAF_AllSNPs.genind)
reportAllelicCapture_Together_Partial(QUAC.R80_NOMAF_AllSNPs.genind)
...
# R100_NOMAF Capture rates
reportAllelicCapture_Together(QUAC.R100_NOMAF_AllSNPs.genind)
reportAllelicCapture_Together_Partial(QUAC.R100_NOMAF_AllSNPs.genind)
...
# R80_NOMAF Capture rates
reportAllelicCapture_Together(QUBO.R80_NOMAF_AllSNPs.genind)
reportAllelicCapture_Together_Partial(QUBO.R80_NOMAF_AllSNPs.genind)
