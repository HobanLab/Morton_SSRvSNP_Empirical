...
plot_multipleK <- function(kList, kValues, kColors, tickMarks, parFlag=TRUE, 
...
Plot_K(QUAC.SNP.DN.S.clumppDir, K=6, Colors = QUAC.colors, QUAC.sampleNames, QUAC.popNames, 
       mainTitle = "QUAC Wild Samples (Subset), SNP: De novo: K6 (Evanno)")
# Plot tick marks and add group labels
axis(1, at=QUAC.tickMarks_SingleK, labels = FALSE, lwd.ticks = 2, tck=-0.15)
...
# Plot QUAC K=6 values (Max Probability Best K)
Plot_K(QUAC.SNP.DN.S.clumppDir, K=6, Colors = QUAC.colors, QUAC.sampleNames, QUAC.popNames, 
       mainTitle = "QUAC Wild Samples (Subset), SNP: De novo: K6 (Max Probability)")
# Plot tick marks and add group labels
axis(1, at=QUAC.tickMarks_SingleK, labels = FALSE, lwd.ticks = 2, tck=-0.15)
text(x=QUAC.labelPositions_SingleK, y=-0.063, srt=35, adj=1, xpd=TRUE, labels=QUAC.labelNames, cex=1)
...
# Plot QUAC K=4 values (Evanno Best K)
Plot_K(QUAC.SNP.REF.clumppDir, K=4, Colors = QUAC.colors, QUAC.sampleNames, QUAC.popNames,
       mainTitle = "QUAC Wild Samples (Subset), SNP: Reference K4 (Evanno)")
# Plot tick marks and add group labels
axis(1, at=QUAC.tickMarks_SingleK, labels = FALSE, lwd.ticks = 2, tck=-0.15)
text(x=QUAC.labelPositions_SingleK, y=-0.063, srt=35, adj=1, xpd=TRUE, labels=QUAC.labelNames, cex=1)
...
Plot_K(QUBO.SNP.DN.clumppDir, K=5, Colors = QUBO.colors, QUBO.sampleNames, QUBO.popNames, 
       mainTitle = "QUBO Wild Samples (Subset), SNP: De novo: K5 (Evanno)")
# Plot tick marks and add group labels
axis(1, at=QUBO.tickMarks_SingleK, labels = FALSE, lwd.ticks = 2, tck=-0.15)
text(x=QUBO.labelPositions_SingleK, y=-0.05, srt=35, adj=1, xpd=TRUE, labels=QUBO.labelNames, cex=1)
...
# Plot QUBO K=5 values (Evanno Best K)
Plot_K(QUBO.SNP.REF.clumppDir, K=5, Colors = QUBO.colors, QUBO.sampleNames, QUBO.popNames, 
       mainTitle = "QUBO Wild Samples (Subset), SNP: Reference: K5 (Evanno)")
# Plot tick marks and add group labels
axis(1, at=QUBO.tickMarks_SingleK, labels = FALSE, lwd.ticks = 2, tck=-0.15)
text(x=QUBO.labelPositions_SingleK, y=-0.05, srt=35, adj=1, xpd=TRUE, labels=QUBO.labelNames, cex=1)
