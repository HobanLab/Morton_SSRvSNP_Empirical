...
# Script for running the stacks-integrate-alignments script for the BWA alignment between QUBO de novo consensus reads catalog and the Q. robur reference genome
...
stacks-integrate-alignments --in-path /RAID1/IMLS_GCCO/Analysis/Stacks/denovo_finalAssemblies/QUBO/output/ --bam-path /RAID1/IMLS_GCCO/Alignment/denovoConsensus/QUBO/BWA/QUBO_denovo_catalog_BWA.bam -O ./output/ --min_alncov 0.8 --min_pctid 0.8 --verbose
...
populations -P ./output -O ./populations --popmap ./QUBO_popmap --threads 28 -R 80 
