...
# Heterozygosity
QUAC.SNP.DN.R0_HZ <- Hs(QUAC.SNP.DN.R0_genind); print(QUAC.SNP.DN.R0_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# Heterozygosity
QUAC.SNP.DN.R80_HZ <- Hs(QUAC.SNP.DN.R80_genind); print(QUAC.SNP.DN.R80_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# 
# # Heterozygosity
# QUAC.SNP.DN.R80.HapSNP_HZ <- Hs(QUAC.SNP.DN.R80.HapSNP_genind); print(QUAC.SNP.DN.R80.HapSNP_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUAC.SNP.DN.R80.HapSNP_genind); ncol(QUAC.SNP.DN.R80.HapSNP_genind@tab)
# # Allelic richness: values per population
# QUAC.SNP.DN.R80.HapSNP_AR <- apply(allelic.richness(QUAC.SNP.DN.R80.HapSNP_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUAC.SNP.DN.R80.HapSNP_AR)
...
# Heterozygosity
QUAC.SNP.REF.R0_HZ <- Hs(QUAC.SNP.REF.R0_genind); print(QUAC.SNP.REF.R0_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# Heterozygosity
QUAC.SNP.REF.R80_HZ <- Hs(QUAC.SNP.REF.R80_genind); print(QUAC.SNP.REF.R80_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# De novo
QUAC.SNP.DN.R0.subset_HZ <- Hs(QUAC.SNP.DN.R0.subset_genind); print(QUAC.SNP.DN.R0.subset_HZ)
QUAC.SNP.DN.R80.subset_HZ <- Hs(QUAC.SNP.DN.R80.subset_genind); print(QUAC.SNP.DN.R80.subset_HZ)
# Reference
QUAC.SNP.REF.R0.subset_HZ <- Hs(QUAC.SNP.REF.R0.subset_genind); print(QUAC.SNP.REF.R0.subset_HZ)
QUAC.SNP.REF.R80.subset_HZ <- Hs(QUAC.SNP.REF.R80.subset_genind); print(QUAC.SNP.REF.R80.subset_HZ)
...
# De novo
nLoc(QUAC.SNP.DN.R0.subset_genind); ncol(QUAC.SNP.DN.R0.subset_genind@tab)
nLoc(QUAC.SNP.DN.R80.subset_genind); ncol(QUAC.SNP.DN.R80.subset_genind@tab)
# Reference
nLoc(QUAC.SNP.REF.R0.subset_genind); ncol(QUAC.SNP.REF.R0.subset_genind@tab)
nLoc(QUAC.SNP.REF.R80.subset_genind); ncol(QUAC.SNP.REF.R80.subset_genind@tab)
# Allelic richness: values per population
...
# 
# # Heterozygosity
# QUAC.Wild.SNP.DN.R0_HZ <- Hs(QUAC.Wild.SNP.DN.R0_genind); print(QUAC.Wild.SNP.DN.R0_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUAC.Wild.SNP.DN.R0_genind); ncol(QUAC.Wild.SNP.DN.R0_genind@tab)
# # Allelic richness: values per population
# QUAC.Wild.SNP.DN.R0_AR <- apply(allelic.richness(QUAC.Wild.SNP.DN.R0_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUAC.Wild.SNP.DN.R0_AR)
# 
# # R80 ----
...
# 
# # Heterozygosity
# QUAC.Wild.SNP.DN.R80_HZ <- Hs(QUAC.Wild.SNP.DN.R80_genind); print(QUAC.Wild.SNP.DN.R80_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUAC.Wild.SNP.DN.R80_genind); ncol(QUAC.Wild.SNP.DN.R80_genind@tab)
# # Allelic richness: values per population
# QUAC.Wild.SNP.DN.R80_AR <- apply(allelic.richness(QUAC.Wild.SNP.DN.R80_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUAC.Wild.SNP.DN.R80_AR)
...
# Heterozygosity
QUBO.SNP.DN.R0_HZ <- Hs(QUBO.SNP.DN.R0_genind); print(QUBO.SNP.DN.R0_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# Heterozygosity
QUBO.SNP.DN.R80_HZ <- Hs(QUBO.SNP.DN.R80_genind); print(QUBO.SNP.DN.R80_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# Heterozygosity
QUBO.SNP.REF.R0_HZ <- Hs(QUBO.SNP.REF.R0_genind); print(QUBO.SNP.REF.R0_HZ)
# Barplot for expected heterozygosity, SNP markers
...
# 
# # Heterozygosity
# QUBO.SNP.REF.R80.HapSNP_HZ <- Hs(QUBO.SNP.REF.R80.HapSNP_genind); print(QUBO.SNP.REF.R80.HapSNP_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUBO.SNP.REF.R80.HapSNP_genind); ncol(QUBO.SNP.REF.R80.HapSNP_genind@tab)
# # Allelic richness: values per population
# QUBO.SNP.REF.R80.HapSNP_AR <- apply(allelic.richness(QUBO.SNP.REF.R80.HapSNP_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUBO.SNP.REF.R80.HapSNP_AR)
...
# De novo
QUBO.SNP.DN.R0.subset_HZ <- Hs(QUBO.SNP.DN.R0.subset_genind); print(QUBO.SNP.DN.R0.subset_HZ)
QUBO.SNP.DN.R80.subset_HZ <- Hs(QUBO.SNP.DN.R80.subset_genind); print(QUBO.SNP.DN.R80.subset_HZ)
# Reference
QUBO.SNP.REF.R0.subset_HZ <- Hs(QUBO.SNP.REF.R0.subset_genind); print(QUBO.SNP.REF.R0.subset_HZ)
QUBO.SNP.REF.R80.subset_HZ <- Hs(QUBO.SNP.REF.R80.subset_genind); print(QUBO.SNP.REF.R80.subset_HZ)
# Barplot for expected heterozygosity, MSAT subset
...
# De novo
nLoc(QUBO.SNP.DN.R0.subset_genind); ncol(QUBO.SNP.DN.R0.subset_genind@tab)
nLoc(QUBO.SNP.DN.R80.subset_genind); ncol(QUBO.SNP.DN.R80.subset_genind@tab)
# Reference
nLoc(QUBO.SNP.REF.R0.subset_genind); ncol(QUBO.SNP.REF.R0.subset_genind@tab)
nLoc(QUBO.SNP.REF.R80.subset_genind); ncol(QUBO.SNP.REF.R80.subset_genind@tab)
# Allelic richness: values per population
...
# 
# # Heterozygosity
# QUBO.Wild.SNP.DN.R0_HZ <- Hs(QUBO.Wild.SNP.DN.R0_genind); print(QUBO.Wild.SNP.DN.R0_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUBO.Wild.SNP.DN.R0_genind); ncol(QUBO.Wild.SNP.DN.R0_genind@tab)
# # Allelic richness: values per population
# QUBO.Wild.SNP.DN.R0_AR <- apply(allelic.richness(QUBO.Wild.SNP.DN.R0_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUBO.Wild.SNP.DN.R0_AR)
# 
# # R80 ----
...
# 
# # Heterozygosity
# QUBO.Wild.SNP.DN.R80_HZ <- Hs(QUBO.Wild.SNP.DN.R80_genind); print(QUBO.Wild.SNP.DN.R80_HZ)
# # Barplot for expected heterozygosity, SNP markers
...
# 
# # Loci count, allele count
# nLoc(QUBO.Wild.SNP.DN.R80_genind); ncol(QUBO.Wild.SNP.DN.R80_genind@tab)
# # Allelic richness: values per population
# QUBO.Wild.SNP.DN.R80_AR <- apply(allelic.richness(QUBO.Wild.SNP.DN.R80_genind)$Ar, 2, mean, na.rm=TRUE)
# print(QUBO.Wild.SNP.DN.R80_AR)
