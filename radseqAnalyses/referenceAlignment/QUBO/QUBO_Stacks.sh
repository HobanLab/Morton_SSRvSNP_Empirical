...
# This script contains the Stacks ref_map.pl and populations commands for filtered, reference aligned QUBO reads
...
populations -P ../ -O ./ -M ./QUBO_popmap_GardenWild -t 15 --hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
# R80 missing data fileter
populations -P ../ -O ./ -M ./QUBO_popmap_GardenWild -t 15 -R 80 --hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
