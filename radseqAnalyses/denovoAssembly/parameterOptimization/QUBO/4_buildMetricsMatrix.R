...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
assemblyFilepath <- "/RAID1/IMLS_GCCO/Analysis/Stacks/denovo_paramOpt/QUBO/analysis/QUBO_assemblyMetrics.Rdata"
...
if(is.na(assemblyMetrics.mat[1,1])){
  ...
  if(nrow(assemblyMetrics.mat)==80){
    rownames(assemblyMetrics.mat) <- read.csv("/RAID1/IMLS_GCCO/Analysis/Stacks/denovo_paramOpt/QUBO/output/QUBO_assemblies", header=FALSE)[,1]
  }
}
