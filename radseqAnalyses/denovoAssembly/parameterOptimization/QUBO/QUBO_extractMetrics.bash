...
# Script for extracting 4 metrics from Stacks QUBO de novo assembly output, in order to assess quality of denovo assembly for each specific parameter set
...
while IFS=, read -r assembly; do
	...
	Rscript /home/user/Documents/SSRvSNP/Code/denovoAssembly/parameterOptimization/QUBO/build_QUBO_assemblyMetricsMatrix.R
