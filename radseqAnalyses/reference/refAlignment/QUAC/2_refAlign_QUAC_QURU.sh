...
# This script generates alignments between Quercus acerifolia NextRAD samples and the Q. rubra reference genome using
...
while read sample; do
        ...
        sam=/RAID1/IMLS_GCCO/Alignment/filteredReads/QUAC/REF_QURU/GSNAP4/${sample}.sam
        bam=/RAID1/IMLS_GCCO/Alignment/filteredReads/QUAC/REF_QURU/GSNAP4/${sample}.bam
        ...
        gsnap -t 24 --gunzip -d ReferenceGenome/Q_rubra/REF_QURU_GMAP -A sam --omit-softclipped -i 2 -m 4 --min-coverage=0.95 $fq1 $fq2 > $sam
        ...
        echo ${sample} >> /RAID1/IMLS_GCCO/Alignment/filteredReads/QUAC/REF_QURU/GSNAP4/QUAC_filtered_algnSummary_GSNAP4.tsv
        samtools flagstat -O tsv $bam >> /RAID1/IMLS_GCCO/Alignment/filteredReads/QUAC/REF_QURU/GSNAP4/QUAC_filtered_algnSummary_GSNAP4.tsv
done
