...
# This script runs the populations module for the QUBO optimized de novo assembly (m7, M5, n5, gt-alpha 0.01).
...
QUBO_DN_DIR="/RAID1/IMLS_GCCO/Analysis/Stacks/denovo_finalAssemblies/QUBO/output/originalOutput"
...
# WILD ONLY %%%
# Complete
populations -P $QUBO_DN_DIR -O ./ -M ./QUBO_popmap_Wild -t 16 -hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
populations -P $QUBO_DN_DIR -O ./ -M ./QUBO_popmap_Wild -t 16 -R 80 -hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
# Subset
populations -P $QUBO_DN_DIR -O ./ -M ./QUBO_popmap_Wild_Subset -t 16 -hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
populations -P $QUBO_DN_DIR -O ./ -M ./QUBO_popmap_Wild_Subset -t 16 -R 80 -hwe --write-single-snp --fstats --fasta-samples --vcf --genepop --structure --plink --phylip-var-all
