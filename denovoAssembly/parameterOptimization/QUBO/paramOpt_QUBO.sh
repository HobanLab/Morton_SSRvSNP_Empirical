...
while IFS=, read -r m M n gtalpha; do
	...
	denovo_map.pl -T 28 -m $m -M $M -n $n --gt-alpha $gtalpha --samples ../../process_RADtags/QUBO/ --popmap ./popmap_QUBO_paramOpt -o ./output/QUAC_m${m}_M${M}_n${n}_ga${gtalpha}/ --paired --rm-pcr-duplicates -X "populations: -R 80"
	sleep 5s
done < ../denovo.params
