...
mtext(side=3, line=1.5, at=2.8, adj=0, cex=0.75, subtitle)
...
boxplot(weighted_cov~m,data=quac.assembly.mat, xlab="m", ylab="Weighted coverage")
...
boxplot(weighted_cov~M,data=quac.assembly.mat, xlab="M/n", ylab="Weighted coverage")
...
boxplot(weighted_cov~gt.alpha,data=quac.assembly.mat, xlab="gt-alpha", ylab="Weighted coverage")
