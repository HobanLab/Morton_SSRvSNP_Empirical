...
pdf(file = paste0(imageOutDir, "mainText/Fig_1.pdf"), width = 9, height = 7.5)
...
matplot(QUAC.MSAT.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
title("Microsatellites", line=0.15, cex=2)
legend(x=75, y=76, inset = 0.05, legend = c("Total","Very common","Common","Low frequency", "Rare"),
       col=plotColors, pch = c(20,20,20), cex=1.2, pt.cex = 2, bty="n", y.intersp = 1.3)
...
# Plots all sets of points onto single graph, as well as 95% threshold line
matplot(QUAC.SNP.DN.R80.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
...
# Plots all sets of points onto single graph, as well as 95% threshold line
matplot(QUAC.SNP.REF.R80.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
...
# MSAT
# Plots all sets of points onto single graph, as well as 95% threshold line
matplot(QUBO.MSAT.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
title("Microsatellites", line=0.15, cex=2)
...
par(mar=c(3,4.5,3,1.5)+0.1)
# Plots all sets of points onto single graph, as well as 95% threshold line
matplot(QUBO.SNP.DN.R80.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
title("SNPs: De novo (R80)", line=0.15, cex=2)
legend(x=80, y=76, inset = 0.05, legend = c("Total","Very common","Common","Low frequency", "Rare"),
       col=plotColors, pch = c(20,20,20), cex=1.2, pt.cex = 2, bty="n", y.intersp = 1.3)
# Lines for 95% threshold
...
par(mar=c(4,4.5,2,1.5)+0.1)
# Plots all sets of points onto single graph, as well as 95% threshold line
matplot(QUBO.SNP.REF.R80.Subset.meanValuesMat, ylim=c(0,110), col=plotColors, pch=16, ylab="")
title("SNPs: Reference (R80)", line=0.15, cex=2)
legend(x=80, y=76, inset = 0.05, legend = c("Total","Very common","Common","Low frequency", "Rare"),
       col=plotColors, pch = c(20,20,20), cex=1.2, pt.cex = 2, bty="n", y.intersp = 1.3)
# Lines for 95% threshold
...
QUAC.MSAT.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S10.pdf")
...
# Subset
QUAC.MSAT.Subset.arrayPath <- paste0(resamplingDataDir,"QUAC.MSAT.Subset_resampArr.Rdata")
QUAC.MSAT.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S11.pdf")
# Generate resampling plot
...
QUAC.SNP.DN.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S12.pdf")
...
QUAC.SNP.DN.R80.Subset.arrayPath <- paste0(resamplingDataDir,"QUAC.SNP.DN.R80.Subset_resampArr.Rdata")
QUAC.SNP.DN.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S13.pdf")
# Generate resampling plot (R0 and R80)
...
QUAC.SNP.REF.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S14.pdf")
# Generate resampling plot (R0 and R80)
...
QUAC.SNP.REF.R80.Subset.arrayPath <- paste0(resamplingDataDir,"QUAC.SNP.REF.R80.Subset_resampArr.Rdata")
QUAC.SNP.REF.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S15.pdf")
# Generate resampling plot (R0 and R80)
...
QUBO.MSAT.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S16.pdf")
# Generate resampling plot
...
# Subset
QUBO.MSAT.Subset.arrayPath <- paste0(resamplingDataDir,"QUBO.MSAT.Subset_resampArr.Rdata")
QUBO.MSAT.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S17.pdf")
# Generate resampling plot
...
QUBO.SNP.DN.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S18.pdf")
# Generate resampling plot (R0 and R80)
...
QUBO.SNP.DN.R80.Subset.arrayPath <- paste0(resamplingDataDir,"QUBO.SNP.DN.R80.Subset_resampArr.Rdata")
QUBO.SNP.DN.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S19.pdf")
# Generate resampling plot (R0 and R80)
...
QUBO.SNP.REF.Complete.imagePath <- paste0(imageOutDir,"supplement/Fig_S20.pdf")
# Generate resampling plot (R0 and R80)
...
QUBO.SNP.REF.R80.Subset.arrayPath <- paste0(resamplingDataDir,"QUBO.SNP.REF.R80.Subset_resampArr.Rdata")
QUBO.SNP.REF.Subset.imagePath <- paste0(imageOutDir,"supplement/Fig_S21.pdf")
# Generate resampling plot (R0 and R80)
